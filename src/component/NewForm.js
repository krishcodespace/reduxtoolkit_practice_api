...
import { setStudentData, deleteData,updateData } from './../app/features/studentSlice';
import Edit from "../assets/edit.png";
import Remove from "../assets/remove.png";

function NewForm() {
    const final = useSelector((state)=> state?.studentSlice?.studentData);
    ...
    <div>
      ...
      <div className="overflow-x-auto">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                    {
                        final.length >= 0 && final.map((item,id)=>{
                            return(
